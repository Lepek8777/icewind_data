...
scoreboard players add @s[scores={sc_temp=-50..-10}] sc_temp 8
...
scoreboard players add @a[scores={sc_temp=-50..-10},gamemode=!spectator,gamemode=!creative,distance=..0.8,limit=3,sort=nearest] sc_temp 2

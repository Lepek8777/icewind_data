...
execute as @s[gamemode=!spectator] at @s anchored eyes unless predicate coldsweat_datapack:is_sneaking unless block ^ ^ ^2.5 #coldsweat_datapack:water unless block ^ ^ ^2 #coldsweat_datapack:water if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"cold",iswaterskin:"true"}] run function coldsweat_datapack:waterskin/use/drink/cold
execute as @s[gamemode=!spectator] at @s anchored eyes unless predicate coldsweat_datapack:is_sneaking unless block ^ ^ ^2.5 #coldsweat_datapack:water unless block ^ ^ ^2 #coldsweat_datapack:water if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"neutral",iswaterskin:"true"}] run function coldsweat_datapack:waterskin/use/drink/neutral
execute as @s[gamemode=!spectator] at @s anchored eyes unless predicate coldsweat_datapack:is_sneaking unless block ^ ^ ^2.5 #coldsweat_datapack:water unless block ^ ^ ^2 #coldsweat_datapack:water if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"hot",iswaterskin:"true"}] run function coldsweat_datapack:waterskin/use/drink/hot

...
execute as @a[gamemode=!spectator] at @s if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand minecraft:music_disc_11[minecraft:custom_data={iswaterskin: "true",waterskin: "cold"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/pouring
execute as @a[gamemode=!spectator] at @s if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand minecraft:music_disc_11[minecraft:custom_data={iswaterskin: "true",waterskin: "neutral"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/pouring
execute as @a[gamemode=!spectator] at @s if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand minecraft:music_disc_11[minecraft:custom_data={iswaterskin: "true",waterskin: "hot"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/pouring

execute as @a[gamemode=!spectator] at @s unless predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand minecraft:music_disc_11[minecraft:custom_data={iswaterskin: "true"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/normal

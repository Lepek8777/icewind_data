...
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.mainhand minecraft:music_disc_13[minecraft:custom_data~{iswaterskin: "true"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/normal

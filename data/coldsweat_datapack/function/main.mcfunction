...
execute as @s[gamemode=!spectator] at @s anchored eyes if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"cold",iswaterskin:"true"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/normal
execute as @s[gamemode=!spectator] at @s anchored eyes if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"neutral",iswaterskin:"true"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/normal
execute as @s[gamemode=!spectator] at @s anchored eyes if predicate coldsweat_datapack:is_sneaking if items entity @s weapon.mainhand *[minecraft:custom_data~{waterskin:"hot",iswaterskin:"true"}] run item modify entity @s weapon.mainhand coldsweat_datapack:waterskin/animation/normal

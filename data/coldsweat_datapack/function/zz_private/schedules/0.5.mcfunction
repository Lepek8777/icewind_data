...
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.offhand minecraft:lily_pad run item modify entity @s weapon.offhand coldsweat_datapack:update_lily_pad

execute as @a[gamemode=!spectator] at @s if items entity @s player.cursor #coldsweat_datapack:fish run item modify entity @s player.cursor coldsweat_datapack:update_fish
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.mainhand #coldsweat_datapack:fish run item modify entity @s weapon.mainhand coldsweat_datapack:update_fish
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.offhand #coldsweat_datapack:fish run item modify entity @s weapon.offhand coldsweat_datapack:update_fish

execute as @a[gamemode=!spectator] at @s if items entity @s player.cursor minecraft:pufferfish run item modify entity @s player.cursor coldsweat_datapack:update_pufferfish

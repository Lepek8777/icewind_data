...
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.offhand #minecraft:fishes run item modify entity @s weapon.offhand coldsweat_datapack:update_fish

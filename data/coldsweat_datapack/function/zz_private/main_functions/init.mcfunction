...
function coldsweat_datapack:zz_private/schedules/10
function coldsweat_datapack:zz_private/schedules/12
function coldsweat_datapack:zz_private/schedules/5

...
execute as @a[gamemode=!spectator,gamemode=!creative,scores={sc_temp=60..}] if predicate icewind:fire_protection run function icewind:zz_private/main_functions/other/enchantments/fire_protection
execute as @a[gamemode=!spectator,gamemode=!creative,scores={sc_temp=..-60}] if predicate icewind:snow_protection run function icewind:zz_private/main_functions/other/enchantments/snow_protection

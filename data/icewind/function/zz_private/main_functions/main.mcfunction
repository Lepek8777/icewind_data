...
execute as @e[type=minecraft:item_display,tag=scarecrow,limit=8,sort=random] at @s if entity @e[type=minecraft:phantom,distance=..14] as @e[type=minecraft:phantom,distance=..14,limit=1,sort=nearest] at @s run data modify entity @s Motion[1] set value 0.2

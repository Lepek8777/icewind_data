...
execute as @a[gamemode=!spectator] at @s if items entity @s weapon.mainhand minecraft:music_disc_13[minecraft:custom_data={iscarecrow: "true"},!minecraft:consumable] run item modify entity @s weapon.mainhand icewind:unlock_scarecrow
